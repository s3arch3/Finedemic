  ...
  <div class="row">
    <div class="col-md-6 offset-md-3">
      ...
      if (isset($_SESSION['user_id'])) {
        ...
        echo '<p class="text-white bg-dark text-center">Welcome <strong>' . $_SESSION['username'] . '</strong>, create your reservation here!</p>';
        ...
        //* reservation form markup creation
        echo '
        <div class="signup-form">
          <form action="includes/reservation.inc.php" method="post">
            ...
            <div class="form-group">
              <label for="guests">Enter Telephone Number</label>
